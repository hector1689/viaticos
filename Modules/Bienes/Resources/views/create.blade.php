...
<div class="card-body">
        ...
        <div class="row">
          ...
          <div class="col-md-4">
              <label for="inputPassword4" style="font-size:12px;" class="form-label">Motivo de Alta: </label>
          ...
          <div class="col-md-4">
              <label for="inputPassword4" style="font-size:12px;" class="form-label">Tipo de Bien: </label>
              <select class="form-control" name="">
                <option value="">Controlable</option>
