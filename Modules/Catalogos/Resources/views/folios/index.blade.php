            ...
            <div class="dropdown dropdown-inline" data-toggle="" title="" data-placement="left" data-original-title="Quick actions">
                ...
                <div class="dropdown-menu dropdown-menu-md dropdown-menu-right" style="">
                    ...
                    <ul class="navi navi-hover py-5">
                      ...
                      <li class="navi-item">
                          <a href="/catalogos/folios/create" class="navi-link">
...
tabla = $('#kt_datatable').DataTable({
  ...
  order: [[0, 'desc']],
  ajax: {
    url: "/catalogos/folios/tabla",
  },
  columns: [
    { data: 'dependencia', name : 'dependencia'},
    { data: 'comisario', name : 'comisario'},
    { data: 'superior_inmediato', name : 'superior_inmediato'},
